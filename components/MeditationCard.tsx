...
const CARD_WIDTH = featured => featured ? width - (Spacing.md * 2) : (width / 2) - (Spacing.md * 1.5);

export default function MeditationCard({ meditation, featured = false }: MeditationCardProps) {
